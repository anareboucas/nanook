...
class PathFinder
{
     ...
     * @param eX An integer
     * @param eY An integer
     * @param orientationAngle A double
     * @param obstacles A bool[,]
    */
    ...
    */
    ...
    /** Gets the path.
     * @returns List<String> moveList (The path)
     */
    ...
    */
    struct coord
    {
        ...
        /**
         * @brief Constructor.
         * @param xVal An integer
         * @param yVal An integer
         * @param gradient A double
         */
        ...
        /**
         * @brief Compares this coord object to another to determine their relative ordering.
         * @param other A coord (Another instance to compare)
         * @returns Negative if this object is less than the other, 0 if they are equal, or positive if this is greater.
         */
        ...
        /**
         * @brief Tests if this coord is considered equal to another.
         * @param other A coord (Another instance to compare).
    ...
    /**
     * @brief Holds coord heap in form of array and 2d array of coords, with heap indices
     */
    struct minHeap
    {
        public int size;
        ...
        /**
         * @brief Constructor
         * @param hor An integer
         * @param ver An integer (The version)
         */
        ...
        */
        ...
        /**
         * @brief Adds c
         * @param c A coord - The coord to be added
         */
        ...
        /**
         * @brief Removes the index described by index.
         * @param index An integer
         * @returns removeMe - A coord 
         */
