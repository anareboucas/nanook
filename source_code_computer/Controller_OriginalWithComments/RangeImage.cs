...
namespace Controller
{
  ...
  public class RangeImage
  {
    ...
    */
     ...
     * @param Version An uint
     * \exception "InvalidOperationException" Thrown when the requested operation is invalid (The RangeImage version is not recognized).
     */
     ...
     * @returns A float - The indexed item.
     */
   ...
   */
    ...
    /**
   * @brief Gets the scanner location.
   */
    public PointF ScannerLocation
    { get { return m_ScannerLocation; } }

   /**
   * @brief Gets the scanner primary axis.
   */
    public PointF ScannerPrimaryAxis
    { get { return m_ScannerPrimaryAxis; } }

    /**
    * @brief Converts this object to a point.
     * @param i An integer - Zero-based index of the entry to access.
     * @param j An integer - The int to process.
     * @returns Point - A Vector3 (The given data converted to a point)
    */
    ...
    /**
     * @brief Converts this object to a height map.
     * @returns grid A float[,] (object converted to a height map).
     */
    ...
    /**
     * @brief Converts the MaxDistance to points.
     * @param MaxDistance A float
     * @returns Points A Vector3[] (The given data converted to the points)
     */
    public Vector3[] ConvertToPoints(float MaxDistance)
    {
      ...
      /**
       * @brief Initializes the range values.
       * @param width An integer
       * @param height An integer
