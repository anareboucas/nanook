/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Graphics/Grid.cpp $
 * Author:       $Author: OBTUSE\matthew $
 * Revision:     $Rev: 1212 $
 * Last Updated: $Date: 2007-11-02 09:43:20 -0400 (Fri, 02 Nov 2007) $
 * 
 * 
      ...
      Path::ExtensionMatches(Filename, "Tiff"))
  {
    ...
    if (IsFlagSet(Flags, GridFlags::FORCEELEMENTTYPE))
    {
      ...
      if (m_pHeader->ElementSize == 12)
        PixelFormat = PixelFormat::RGBA128F;
    ...
    else
    {
      ...
      case 3:
        PixelFormat = PixelFormat::RGB96F; Decl.Add(ElementDecl("Value", ElementDeclType::FLOAT, 3)); break;
      case 4:
        PixelFormat = PixelFormat::RGBA128F; Decl.Add(ElementDecl("Value", ElementDeclType::FLOAT, 4)); break;
      };
      SetElementType(Decl);
    }
...
VOID Grid::Export(LPCTSTR Filename, DWORD Flags)
{
      ...
      Path::ExtensionMatches(Filename, "Tiff"))
  {
    ...
    if (m_pHeader->ElementSize == 4)
      PixelFormat = PixelFormat::R32F;
    if (m_pHeader->ElementSize == 12)
      PixelFormat = PixelFormat::RGB96F;
    if (m_pHeader->ElementSize == 16)
      PixelFormat = PixelFormat::RGBA128F;
