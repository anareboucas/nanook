/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Graphics/OpenGL/Context.cpp $
		...
		Light7(7)
{
  m_pWindow = new Window();
	m_pWindow->Create( Window::m_pDefaultWindowClass, TEXT(""), 0, 0, Ptr<Window>::Null, 0, Point(0,0), Point(1,1) );
...
Ptr<Image> Context::ReadFrameBuffer()
{
  ...
  Image* pImage = new Image( S.cx, S.cy );

  glReadPixels(0,0,S.cx,S.cy, GL_BGRA, GL_UNSIGNED_BYTE, (Color*)(*pImage) );
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------
Ptr<ImageF> Context::ReadFloatFrameBuffer()
{
  Size S = m_pWindow->GetClientSize();
  ImageF* pImage = new ImageF( S.cx, S.cy );

  glReadPixels(0,0,S.cx,S.cy, GL_RGBA, GL_UNSIGNED_BYTE, (ColorF*)(*pImage) );
  VerifyOpenGLErrorState();
