/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Graphics/Color.cpp $
...
Lua::Bind::Scope ColorR32F::GenerateBindings( LPCTSTR Name )
{
  ...
  return 
    Class<Graphics::ColorR32F>(Name)
      ...
      .Property( "G", &ColorR32F::GetG, &ColorR32F::SetG )
      .Property( "B", &ColorR32F::GetB, &ColorR32F::SetB )
