/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Collections/TreeImpl.hpp $
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------
template<SIZE_T Degree, class NodeData, class Allocator, class ThreadingModel>
typename TreeNode<NodeData>* Tree<Degree,NodeData,Allocator,ThreadingModel>::CreateChildren(TreeNode<NodeData>* pParent)
{
  Assert(pParent != 0);
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------
template<SIZE_T Degree, class NodeData, class Allocator, class ThreadingModel>
typename TreeNode<NodeData>* Tree<Degree,NodeData,Allocator,ThreadingModel>::CreateRoot()
{
