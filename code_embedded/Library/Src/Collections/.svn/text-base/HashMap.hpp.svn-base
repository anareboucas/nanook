/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Collections/HashMap.hpp $
...
namespace Bolitho
{
  class LIBRARY_API KeyNotFoundException : public Exception
  {
    DeclareRuntimeType();
  public:
    KeyNotFoundException(CONST Object* Sender, String Key) : Exception(Sender)
    { m_Value = Key; }
    ...
    { return String::Format("The key \'%s\' was not found in the hashtable", m_Value.ConstStr()); }
...
//		{ return Get(Key); }
  ...
  public:
    ...
    { return (UINT)(100 * m_Count / m_Bins.Length()); }
  ...
  private:
    ...
    static CONST SIZE_T INVALIDBIN = (SIZE_T)-1;
    ...
    SIZE_T Find(CONST K& Key) CONST;
    BOOL Add(CONST K& Key, CONST V& Value, Buffer<Bin>& Bins);
  };
