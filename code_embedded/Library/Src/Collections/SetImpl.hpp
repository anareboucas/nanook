/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Collections/SetImpl.hpp $
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
ImplementTemplate2RuntimeType(Bolitho,Set,Object);
//----------------------------------------------------------------------------------------------------------------------------------------------------

//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
Set<K,ElementTraits>::Set()
{
	m_pNil = new Node();
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
SIZE_T Set<K,ElementTraits>::Count() CONST
{
	return m_NodeCount;
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
BOOL Set<K,ElementTraits>::IsEmpty() CONST
{
	return m_NodeCount == 0;
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
VOID Set<K,ElementTraits>::Add( CONST K& Key )
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
BOOL Set<K,ElementTraits>::Contains( CONST K& Key ) CONST
{
	Node* pNode = FindNode(Key);
	return pNode != 0;
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
BOOL Set<K,ElementTraits>::operator[] (CONST K& Key) CONST
{
	return Contains(Key);
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Iterator Set<K,ElementTraits>::Find( CONST K& Key ) CONST
{
	Node* pNode = FindNode(Key);
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Enumerator Set<K,ElementTraits>::Items()
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Iterator Set<K,ElementTraits>::End()
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
Set<K,ElementTraits>::Enumerator::Enumerator( Set* pMap )
{
	m_pSet = pMap;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
Set<K,ElementTraits>::Enumerator::operator BOOL()
{
	return IsValid();
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Enumerator Set<K,ElementTraits>::Enumerator::operator ++ ()
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Enumerator& Set<K,ElementTraits>::Enumerator::operator++ (int)
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
BOOL Set<K,ElementTraits>::Enumerator::IsValid()
{
	return m_pNode != 0 && m_pNode != m_pSet->m_pNil;
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
K Set<K,ElementTraits>::Enumerator::CurrentElement()
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
Set<K,ElementTraits>::Iterator::Iterator( Set* pMap, Node* pNode )
{
	m_pSet = pMap;
	m_pNode = pNode;
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
CONST K& Set<K,ElementTraits>::Iterator::operator* () CONST
{
	return m_pNode->m_Key;
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Iterator Set<K,ElementTraits>::Iterator::operator ++ ()
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Iterator& Set<K,ElementTraits>::Iterator::operator++ (int)
{
	m_pNode = m_pSet->Successor(m_pNode);
	return *this;
}
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
BOOL Set<K,ElementTraits>::Iterator::operator== (CONST Iterator& I) CONST
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Node* Set<K,ElementTraits>::Minimum(Node* pNode) CONST
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Node* Set<K,ElementTraits>::Maximum(Node* pNode) CONST
{
	if (pNode == 0 || IsNil(pNode))
		return 0;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Node* Set<K,ElementTraits>::Predecessor( Node* pNode ) CONST 
{
	if( pNode == 0 )
		return 0;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Node* Set<K,ElementTraits>::Successor(Node* pNode) CONST
{
	if ( pNode == 0 )
		return 0;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
BOOL Set<K,ElementTraits>::IsNil(Node* pNode) CONST
{
	return (pNode == m_pNil);
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
VOID Set<K,ElementTraits>::SetNil( Node** pNode )
{
	*pNode = m_pNil;
}
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Node* Set<K,ElementTraits>::FindNode(CONST K& Key) CONST
{
	Node* pKey = 0;
	Node* pNode = m_pRoot;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
typename Set<K,ElementTraits>::Node* Set<K,ElementTraits>::LeftRotate( Node* pNode )
{
	Assert(pNode != 0);
	if(pNode == 0)
		return 0;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
template<class K, class ElementTraits>
VOID Set<K,ElementTraits>::SwapNode( Node* pDest, Node* pSrc)
{
