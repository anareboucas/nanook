/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Collections/Set.hpp $
...
namespace Bolitho
{
  template<class K, class ElementTraits=Traits<K>, class ThreadingModel>
