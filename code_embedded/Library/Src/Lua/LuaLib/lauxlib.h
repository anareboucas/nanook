/*
** $Id: lauxlib.h 632 2007-02-02 14:40:47Z matthew $
...
LUA_API int (luaL_argerror) (lua_State *L, int numarg, const char *extramsg);
LUA_API const char *(luaL_checklstring) (lua_State *L, int numArg,
                                                          size_t *l);
LUA_API const char *(luaL_optlstring) (lua_State *L, int numArg,
