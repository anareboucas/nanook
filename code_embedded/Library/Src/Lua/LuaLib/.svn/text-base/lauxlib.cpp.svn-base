/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Lua/LuaLib/lauxlib.cpp $
...
LUA_API int luaL_argerror (lua_State *L, int narg, const char *extramsg) {
  lua_Debug ar;
...
LUA_API int luaL_checkoption (lua_State *L, int narg, const char *def,
...
LUA_API const char *luaL_optlstring (lua_State *L, int narg,
...
LUA_API lua_Number luaL_checknumber (lua_State *L, int narg) {
...
LUA_API lua_Integer luaL_checkinteger (lua_State *L, int narg) {
...
LUA_API lua_Integer luaL_optinteger (lua_State *L, int narg,
                                                      lua_Integer def) {
  return luaL_opt(L, luaL_checkinteger, narg, def);
}


LUA_API int luaL_getmetafield (lua_State *L, int obj, const char *event) {
...
LUA_API int luaL_callmeta (lua_State *L, int obj, const char *event) {
  obj = abs_index(L, obj);
...
LUA_API void (luaL_register) (lua_State *L, const char *libname,
                                const luaL_Reg *l) {
...
LUA_API void luaI_openlib (lua_State *L, const char *libname,
...
LUA_API const char *luaL_gsub (lua_State *L, const char *s, const char *p,
                                                               const char *r) {
  const char *wild;
  size_t l = strlen(p);
  luaL_Buffer b;
...
LUA_API const char *luaL_findtable (lua_State *L, int idx,
...
LUA_API int luaL_loadbuffer (lua_State *L, const char *buff, size_t size,
                                const char *name) {
  LoadS ls;
  ls.s = buff;
  ls.size = size;
