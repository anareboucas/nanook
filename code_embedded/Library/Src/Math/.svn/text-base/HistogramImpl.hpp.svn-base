/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Math/HistogramImpl.hpp $
...
VOID Histogram1<T>::Add(T X)
{
	...
	UINT IndexX = (UINT)(m_BinCountX * (FLOAT)(X - m_MinBinValue) / (m_MaxBinValue - m_MinBinValue));
	m_pBins[IndexX]++;
