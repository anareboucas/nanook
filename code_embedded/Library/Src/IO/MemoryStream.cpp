/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/IO/MemoryStream.cpp $
 * Author:       $Author: OBTUSE\matthew $
 * Revision:     $Rev: 1387 $
 * Last Updated: $Date: 2007-12-28 08:04:32 -0500 (Fri, 28 Dec 2007) $
 * 
 * 
...
SIZE_T MemoryStream::Write(LPCVOID pData, SIZE_T N)
{
  ...
  if (m_Buffer.Length() < m_BufferOffset + N)
    ...
    {
      if (m_Buffer.Length()*2 < m_BufferOffset + N)
        m_Buffer.Resize(m_BufferOffset + N);
      else
        m_Buffer.Resize(m_Buffer.Length()*2);
    }
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------
ULONGLONG MemoryStream::Length() CONST
{
