/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/IO/MemoryMappedFile.cpp $
 * Author:       $Author: OBTUSE\matthew $
 * Revision:     $Rev: 1203 $
 * Last Updated: $Date: 2007-10-29 18:59:21 -0400 (Mon, 29 Oct 2007) $
 * 
 * 
...
Ptr<MemoryMappedView> MemoryMappedFile::CreateView()
{
  ...
  LPVOID pData = mmap64( 0, m_Length, m_Access, Flags, File, 0 );
...
Ptr<MemoryMappedView> MemoryMappedFile::CreateView( ULONGLONG Offset, SIZE_T Length )
{
  ...
  LPVOID pData = mmap64( 0, Length, m_Access, Flags, File, Offset );
...
Ptr<MemoryMappedView> MemoryMappedFile::CreateView( DWORD Access )
{
  ...
  LPVOID pData = mmap64( 0, m_Length, Access, Flags, File, 0 );
...
Ptr<MemoryMappedView> MemoryMappedFile::CreateView( ULONGLONG Offset, SIZE_T Length, DWORD Access )
{
  ...
  LPVOID pData = mmap64( 0, Length, Access, Flags, File, Offset );
