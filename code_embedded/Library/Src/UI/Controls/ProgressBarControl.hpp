/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/UI/Controls/ProgressBarControl.hpp $
...
namespace Bolitho
{
  namespace UI
  {
    class LIBRARY_API ProgressBarControl : public Control
    {
      DeclareRuntimeType();
    public:
      ProgressBarControl();
