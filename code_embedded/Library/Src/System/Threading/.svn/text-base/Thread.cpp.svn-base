/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/System/Threading/Thread.cpp $
 * Author:       $Author: OBTUSE\matthew $
 * Revision:     $Rev: 1293 $
 * Last Updated: $Date: 2007-11-28 09:04:06 -0500 (Wed, 28 Nov 2007) $
 * 
 * 
...
{
  HANDLE hThread = CreateThread( 0, 0, Proc, Ptr, 0, 0 );
  if (!hThread)
