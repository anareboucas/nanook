/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/System/Threading/ConditionVariable.cpp $
...
BOOL ConditionVariable::Wait( DWORD Timeout )
{
  return SleepConditionVariableCS(&m_ConditionVariable, m_Lock.Handle(), Timeout);
}
//-----------------------------------------------------------------------------------------------------------------------------------------------------
BOOL ConditionVariable::Signal()
{
