/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/System/Threading/Interlocked.hpp $
 * Author:       $Author: OBTUSE\matthew $
 * Revision:     $Rev: 1279 $
 * Last Updated: $Date: 2007-11-17 16:17:14 -0500 (Sat, 17 Nov 2007) $
 * 
 * 
...
namespace Bolitho
{
  ...
  FLOAT InterlockedAccumulate(FLOAT* pFloat, FLOAT V);
  /* Performs an atomic floating point accumulate operation */
  DOUBLE InterlockedAccumulate(DOUBLE* pFloat, DOUBLE V);
