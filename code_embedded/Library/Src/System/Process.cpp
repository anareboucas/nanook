/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/System/Process.cpp $
 * Author:       $Author: OBTUSE\matthew $
 * Revision:     $Rev: 1298 $
 * Last Updated: $Date: 2007-11-28 09:15:36 -0500 (Wed, 28 Nov 2007) $
 * 
 * 
...
Process::PROCESSCOUNTERS Process::GetProcessCounters()
{
  ...
  Info.WallClockTime = Info.ExitTime.Ticks() == 0 ? DateTime::Now() - Info.CreationTime : Info.ExitTime - Info.CreationTime;
