/***************************************************************************************************
 * File:         $URL: http://obtuse.cs.jhu.edu/Projects/Library/Source/Branches/NASABot/Src/Test-Linux.cpp $
 * Author:       $Author: OBTUSE\matthew $
 * Revision:     $Rev: 1235 $
 * Last Updated: $Date: 2007-11-09 11:22:53 -0500 (Fri, 09 Nov 2007) $
 * 
 * 
...
DeclareApplicationClass(TestApplication)
...
INT TestApplication::Main()
{
  ...
  FuncPtr<INT,INT> Foo = CreateFuncPtr(Bar);
